...
# Custom theme (based on the provided base16 theme) for tmux-powerline.
# Uses the base16 color palette to inherit theme from terminal/shell.
# See tmux-powerline directory for default/base16/bubble themes
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"vcs_others 245 0"
		"tmux_continuum_save brightmagenta 0"
		"tmux_continuum_status 245 0"
		"now_playing green black"
		#"cpu 240 136"
		#"load brightblack yellow"
		"tmux_mem_cpu_load cyan 136"
		"battery red white"
